...
def train(config=None):
    ...
    if True:
        ...
        print(f"val aucs: {best_val_aucs}, mean: {np.mean(best_val_aucs)}")
        torch.save(final_save_dict, "bestnlp2023_modelv3.pth")
