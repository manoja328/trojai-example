...
meta_schema= {"$schema": "http://json-schema.org/draft-07/schema#",
              ...
              "technique": "SRI  trigger search + loss analysis",
              "technique_description": "Inserting triggers and analyzing loss of triggered examples.",
              "technique_changes": "Small changes to classifier design.",
              "technique_type": ["Trigger Inversion", "Weight Analysis"],
              "commit_id": sha,
              "repo_name": url,
              "required": [],
